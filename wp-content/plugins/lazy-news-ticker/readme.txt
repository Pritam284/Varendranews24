...
Wanna see how it works? Click here: http://lazypersons.com/plugins/lazy-news-ticker/
...
<pre>[tickr_list id="1"]</pre>


<strong>Ticker form category</strong>
<pre>[tickr_list id="2" category="1"]</pre>


<strong>Speed change</strong>
<pre>[tickr_list id="3" speed="1000"]</pre>

 
<strong>TypeSpeed Change</strong>
<pre>[tickr_list id="4" typespeed="100"]</pre>


<strong>Color variation</strong>
<pre>[tickr_list id="5" color="red"]</pre>

 
<strong>Text change!</strong>
<pre>[tickr_list id="6" text="Breaking News!"]</pre>
